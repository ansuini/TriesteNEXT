...
parser.add_argument('--style_weight', default=1e6, type=int, metavar='N', help='weight of the style loss term in the total loss')
...
content_img = image_loader(os.path.join(ROOT, 'test_images', content_img_name + '.jpg') )
...
index = 0
while os.path.exists(os.path.join(ROOT, 'results', content_img_name + '_' + style_img_name + '_' + str(index) + '.jpg') ):
    index += 1
scipy.misc.toimage(out, cmin=0.0, cmax=255.0).save(os.path.join(ROOT, 'results', content_img_name + '_' + style_img_name + '_' + str(index) +'.jpg') )